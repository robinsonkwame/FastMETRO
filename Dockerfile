...
# Active the conda environment and install necessary packages
RUN /bin/bash -c "source activate fastmetro && conda install pytorch==1.8.0 torchvision==0.9.0 cudatoolkit=11.1 -c pytorch -c conda-forge"
